...
TAGS = ['major_features', 'pairup', 'inventory', 'line_of_sight', 'leveling', 'ai', 'wexp', 'music', 'title', 'other', 'hidden']
...
constants = ConstantCatalog([
    ...
    Constant('turnwheel', "Turnwheel", ConstantType.BOOL, False, 'major_features'),
    Constant('initiative', "Per Unit Initiative Order", ConstantType.BOOL, False, 'major_features'),
    Constant('fatigue', "Fatigue", ConstantType.BOOL, False, 'major_features'),
    Constant('reset_fatigue', "Automatically reset fatigue to 0 for benched units", ConstantType.BOOL, False, 'major_features'),
    Constant('minimap', "Enable Minimap", ConstantType.BOOL, True, 'major_features'),
    Constant('pairup', "Pair Up", ConstantType.BOOL, False, 'pairup'),
    Constant('limit_attack_stance', "Limit Attack Stance to first attack only", ConstantType.BOOL, False, 'pairup'),
    Constant('attack_stance_only', "Only attack stance allowed", ConstantType.BOOL, False, 'pairup'),
    Constant('player_pairup_only', "Only player units can pairup", ConstantType.BOOL, False, 'pairup'),
    Constant('lead', "Global Leadership Stars", ConstantType.BOOL, False, 'major_features'),
    Constant('bexp', "Bonus Experience", ConstantType.BOOL, False, 'major_features'),
    Constant('rd_bexp_lvl', "Always gain 3 stat-ups when using Bonus Exp.", ConstantType.BOOL, False, 'major_features'),
    Constant('support', "Supports", ConstantType.BOOL, False, 'major_features'),
    Constant('overworld', "Overworld", ConstantType.BOOL, False, 'major_features'),
    Constant('overworld_start', "Start in Overworld", ConstantType.BOOL, False, 'major_features'),
    Constant('unit_notes', "Unit Notes", ConstantType.BOOL, False, 'major_features'),
    Constant('crit', "Allow Criticals", ConstantType.BOOL, True, 'major_features'),
    Constant('reset_uses', "Reset uses on droppable items when acquired", ConstantType.BOOL, True, 'other'),
    Constant('allow_negative_as', "Allow Attack Speed to be negative", ConstantType.BOOL, False, 'other'),
    Constant('trade', "Can trade items on map", ConstantType.BOOL, True, 'other'),
    Constant('growth_info', "Can view unit growths in Info Menu", ConstantType.BOOL, True, 'other'),
    Constant('glancing_hit', "Chance (%) to score a glancing hit", ConstantType.INT, 0, 'major_features'),
    Constant('backpropagate_difficulty_growths', "Apply difficulty bonus growths to past levels", ConstantType.BOOL, True, 'other'),
    Constant('traveler_time_decrement', "Timed skills applied to traveler units will decrease.", ConstantType.BOOL, False, 'other'),
    ...
    Constant('def_double', "Defender can double counterattack", ConstantType.BOOL, True, 'other'),
    ...
    Constant('translucent_unit_sprite', "A phantom of current unit will appear at cursor's position", ConstantType.BOOL, False, 'aesthetic'),
    Constant('convoy_on_death', "Items held by dead player units are sent to convoy", ConstantType.BOOL, 'other'),
    Constant('repair_shop', "Access the Repair Shop in prep and base", ConstantType.BOOL, False, 'other'),
    Constant('sound_room_in_codex', "Can access sound room from Codex menu in base", ConstantType.BOOL, True, 'other'),
    Constant('give_and_take', "Units can give a unit after taking a unit", ConstantType.BOOL, 'other'),
    Constant('combat_art_category', "Combat Arts get put in their own category in the menu", ConstantType.BOOL, False, 'other'),
    Constant('reset_mana', "Mana resets to full for units upon completion of the chapter", ConstantType.BOOL, 'other'),
    Constant('double_splash', "When doubling, splash/aoe applied on second strike", ConstantType.BOOL, 'other'),
    ...
    Constant('title_particles', "Display particle effect on title screen", ConstantType.BOOL, True, 'title'),
    Constant('title_sound', "Access sound room in Extras on title screen", ConstantType.BOOL, True, 'title'),
