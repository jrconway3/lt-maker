...
constants = ConstantCatalog([
    ...
    Constant('player_leveling', 'Method for leveling player units', ("Random", "Fixed", "Hybrid", "Dynamic"), "Random"),
    Constant('enemy_leveling', "Method for autoleveling generic units", ("Random", "Fixed", "Hybrid", "Dynamic", "Match"), "Match"),
