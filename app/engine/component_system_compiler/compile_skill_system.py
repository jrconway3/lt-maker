...
exclusive_behaviours = ('can_select', 'no_trade', 'movement_type', 'sight_range', 'empower_splash', 'num_items_offset',
                        'num_accessories_offset', 'change_variant', 'change_animation', 'change_ai', 'change_roam_ai', 'witch_warp')

exclusive_behaviours += formula
# Takes in unit and item, returns default value
item_behaviours = ('modify_buy_price', 'modify_sell_price',
                   'limit_maximum_range', 'wexp_usable_skill', 'wexp_unusable_skill')
...
targeted_behaviours = ('check_ally', 'check_enemy', 'can_trade', 'exp_multiplier', 'enemy_exp_multiplier',
                       'wexp_multiplier', 'enemy_wexp_multiplier', 'has_canto', 'empower_heal', 'empower_heal_received', 'canto_movement')
...
combat_event_hooks = ('start_combat', 'cleanup_combat', 'end_combat', 'pre_combat', 'post_combat',
                      'test_on', 'test_off')
    ...
    for skill in unit.skills[:]:
        for component in skill.components:
            ...
            if component.defines('%s_unconditional'):
                component.%s_unconditional(playback, unit, item, target, mode)""" \
