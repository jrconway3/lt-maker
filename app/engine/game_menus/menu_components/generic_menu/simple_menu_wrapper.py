...
from app.engine.icons import get_icon
...
class SimpleMenuUI():
    def __init__(self, data: List[str] | Callable[[], List] = None, data_type: str = 'str',
        ...
        self.table = SimpleIconTable('table', self.base_component, num_rows=rows, num_columns=cols, title=title, row_width=row_width)
    ...
    def parse_data(self, data: List[NID]) -> List[str] | List[Tuple[engine.Surface, str, NID]]:
