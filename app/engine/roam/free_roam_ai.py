...
from app.engine import ai_controller, engine, equations, evaluate, target_system
...
class RoamAI:
        ...
        while True:
            ...
            if self.behaviour:
                ...
                if self.behaviour.action == 'None':
                    ...
                    region: Optional[Region] = self.find_region()
                    if region:
    ...
    def find_region(self) -> Optional[Region]:
        """
