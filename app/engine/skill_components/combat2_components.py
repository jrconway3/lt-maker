...
class NegateDynamicAttacks(SkillComponent):
    nid = 'negate_dynamic_attacks'
    desc = "Unit cannot be affected by extra attacks generated by skill or item components. Does not apply for Multiattacks."
    tag = SkillTags.COMBAT2
