# pygame mirror of app/map_maker/qt_renderers/renderer_database.py
# Note: both databases share the painter singletons in PAINTERS, so only one
# frontend (the Qt editor or the pygame engine) should be used per process.
from app.map_maker.terrain import Terrain
from app.map_maker.pygame_renderers import (
    SimpleRenderer,
    SimpleRenderer8,
    SeaRenderer,
    DisplayRenderer8,
