...
class SeaRenderer(SimpleRenderer8):
    ...
    def set_palette(self, palette: Palette):
        ...
        limit = {k: find_limit16(self.palette.get_full_pixmap(), k) for k in range(16)}
        sand_limit = {k: find_limit16(self.palette.get_full_pixmap(), k, self.painter.sand_start_px) for k in range(16)}
