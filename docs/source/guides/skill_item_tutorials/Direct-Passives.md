...
### Step 2.1A: Assign the skill to an Unit
Open the **Units Editor** in the **Edit Menu** and select the unit that will get the skill. For this guide I will select the default **unit** Eirika.
...
![8](./images/Direct-Passives/8.png)
...
![11](./images/Direct-Passives/11.png)
...
![12](./images/Direct-Passives/12.png)
...
![13](./images/Direct-Passives/13.png)

Use the **Info Key** again to check the name and description of your skill.

![14](./images/Direct-Passives/14.png)

## Step 3: Add combat component
All the components we will use in this guide belong to the **Combat Components** menu, represented by the **(Single) Sword icon**.

![15](./images/Direct-Passives/15.png)
...
![16](./images/Direct-Passives/16.png)
...
![17](./images/Direct-Passives/17.png)
...
![19](./images/Direct-Passives/19.png)
...
![20](./images/Direct-Passives/20.png)

To add a new stat, click on the **+** button. Select the MAG **Stat** and assign its **Value** to 2.

![21](./images/Direct-Passives/21.png)

The end result should look like this:

![22](./images/Direct-Passives/22.png)
...
![23](./images/Direct-Passives/23.png)
